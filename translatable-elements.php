<? $translatable_elements = [
	...
	"biographical-notes-representative" => [
		"en"	=> "Representative assigned by the community of Jews from Kurdistan to supervise and consult on Jewish concerns in the Kurdistan Region (2020 - ongoing).",
		"he"	=> "",
		"ar"	=> "",
		"ku"	=> "",
		],
	...
	"biographical-notes-author" => [
		"en"	=> "Author of ‘The Jews of Kurdistan’, and 2019 recipient of the Prime Minister’s Prize for his lifetime of research and dedication on the Kurdish Jewish community.",
		"he"	=> "",
		"ar"	=> "",
		"ku"	=> "",
		],
