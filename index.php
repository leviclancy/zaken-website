...
function translatable_elements($string_id, $language_temp=null, $html_tag_temp=null) {
	...
	foreach ($string_array_temp as $string_temp):
		...
		$replace_array["length_".strlen($string_temp)."_".rand(1000000,9999999)] = [
			"search" => $string_temp,
			"replace" => "<a href='".$string_temp."' target='_blank'>".current(explode("/", str_replace(["https://www.", "http://www.", "https://", "http://",], null, $string_temp)))."</a>"
			];
		endforeach;
...
//	echo blockquote("", "");
	...
	echo press_report_output("2017-10-05", "Au Kurdistan irakien, la difficile renaissance du judaïsme, par Ines Gil", "https://www.tribunejuive.info/2017/10/05/au-kurdistan-irakien-la-difficile-renaissance-du-judaisme-22-par-ines-gil/", "tribunejuive.info");
