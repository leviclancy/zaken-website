...
echo "<div id='Contact'>";
	...
	echo "<div id='contact-footer-primary'>";
		...
		echo "Email: &nbsp; <a href='mailto:info@drmordechaizaken.com'>info@drmordechaizaken.com</a>";
		echo "</div>";
	...
	echo "<div class='contact-footer-secondary'>";
		...
		echo "Website: &nbsp; <a href='https://kurdishjewry.org.il'>kurdishjewry.org.il</a><br>";
		echo "Email: &nbsp; <a href='mailto:info@kurdishjewry.org.il'>info@kurdishjewry.org.il</a>";
		echo "</div>";
	...
	echo "<div class='contact-footer-secondary'>";
		...
		echo "Email: &nbsp; <a href='mailto:info@ours.foundation'>info@ours.foundation</a><br>";
		echo "WhatsApp: &nbsp; <a href='https://wa.me/12072165608'>+1 (207) 216-5608</a>";
		echo "</div>";
